...
- Shell: [zsh](https://github.com/zsh-users/zsh)
  - [pure-prompt](git@github.com:sindresorhus/pure.git)                                            :  Pretty, minimal and fast ZSH prompt 
...
```sh
yadm clone --recursive git@github.com:mstuttgart/dotfiles.git --no-bootstrap
```
