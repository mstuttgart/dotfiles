...
# Original file from: https://github.com/willianjusten/dotfiles/blob/master/colors.sh

function new_line { echo -e ""; }
function print { echo -e "\033[1;34m=> $1\033[0m"; }
function msg_ok { echo -e "\033[1;32m[ok] $1 ✔\033[0m"; }
function msg_update { echo -e "\033[1;33m[update] $1 \033[0m"; }
function msg_install { echo -e "\033[1;33m[installing] $1 \033[0m"; }
function msg_installed { echo -e "\033[1;32m[installed] $1 ✔\033[0m"; }
