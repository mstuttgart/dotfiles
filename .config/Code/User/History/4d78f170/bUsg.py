...
class HTAbout(http.Controller):
    ...
    def about(self, **kwargs):
        return http.request.render('jt_corporate2201_theme.about_page')
...
class HTService(http.Controller):
    ...
    def services(self, **kwargs):
        return http.request.render('jt_corporate2201_theme.service_page')
...
class HTPortfolio(http.Controller):
    ...
    def portfolio(self, **kwargs):
        return http.request.render('jt_corporate2201_theme.portfolio_page')
...
class HTContact(http.Controller):
    ...
    def contact(self, **kwargs):
        return http.request.render('jt_corporate2201_theme.contact_page')
