...
class InvoiceElectronic(models.Model):
                    ...
                    if rec.state == 'done':
                        ...
                        try:
                            ...
                            if response.status_code == 200:
                                ...
                                rec.tecnospeed_xml_name = f'{self.numero} - NFSe - {self.partner_id.name}.pdf'
    ...
    def action_print_einvoice_report(self):
        ...
        if self.model == '001' and self.nfe_engine == 'tecnospeed' and self.state in ['done', 'cancel'] and self.tecnospeed_nfse_pdf:
