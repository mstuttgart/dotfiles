...
set('i', '<C-h>', '<Left>', { desc = 'Go to left window' })
set('i', '<C-j>', '<Down>', { desc = 'Go to lower window' })
set('i', '<C-k>', '<Up>', { desc = 'Go to upper window' })
set('i', '<C-l>', '<Right>', { desc = 'Go to right window' })
