...
set('i', '<C-h>', '<Left>h', { desc = 'Go to left window' })
set('i', '<C-j>', '<Up>j', { desc = 'Go to lower window' })
set('i', '<C-k>', '<C-w>k', { desc = 'Go to upper window' })
set('i', '<C-l>', '<C-w>l', { desc = 'Go to right window' })
