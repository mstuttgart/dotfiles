...
local plugin = {
    ...
    keys = {
        { '<leader>ee', '<cmd>NvimTreeToggle<cr>', desc = '[T]oggle  [T]ree' },
        { '<leader>ef', '<cmd>NvimTreeFindFile<cr>', desc = '[T]ree open with current [F]ile' },
        { '<leader>er', '<cmd>NvimTreeRefresh<cr>', desc = '[T]ree [R]efresh' },
    },
    init = function()
