                    ...
                    lualine_x = {
                        ...
                        -- stylua: ignore
                        {
                            ...
                            color = function()
                                ...
                                local hl = vim.api.nvim_get_hl and vim.api.nvim_get_hl(0, { name = 'Statement' }) or
                                    vim.api.nvim_get_hl_by_name('Statement', true)
                        ...
                        -- stylua: ignore
                        {
                            ...
                            color = function()
                                ---@type {foreground?:number}?
                                ---@diagnostic disable-next-line: deprecated
                                local hl = vim.api.nvim_get_hl and vim.api.nvim_get_hl(0, { name = 'Constant' }) or
                                    vim.api.nvim_get_hl_by_name('Constant', true)
                                ---@diagnostic disable-next-line: undefined-field
                                local fg = hl and (hl.fg or hl.foreground)
                                return fg and { fg = string.format("#%06x", fg) } or nil
                            end
