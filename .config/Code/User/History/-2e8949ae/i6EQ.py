...
class AccountInvoice(models.Model):
    ...
    def _prepare_edoc_vals(self, invoice):
        ...
        res['nfse_tecnospeed_natureza_operacao'] = self.fiscal_position_id.nfse_tecnospeed_natureza_operacao
        # res['nfse_tecnospeed_regime_tributacao'] = self.company_id.nfse_tecnospeed_regime_tributacao
        # res['nfse_tecnospeed_incentivador_cultural'] = self.company_id.nfse_tecnospeed_incentivador_cultural
        # res['nfse_tecnospeed_incentivo_fiscal'] = self.company_id.nfse_tecnospeed_incentivo_fiscal
