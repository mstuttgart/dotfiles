...
return {
  ...
  -- buffer + tab line
  {
    ...
    keys = {
      { '[b', '<Cmd>BufferLineGroupClose ungrouped<CR>', desc = 'Delete all buffers' },
      { 'b]', '<Cmd>BufferLineCycleNext<CR>', desc = 'Delete all buffers' },
      { '<S-Tab>', '<Cmd>BufferLineCyclePrev<CR>', desc = 'Delete all buffers' },
    },
    config = function()
