...
class AccountConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        # a required string
        set_param('br_account_einvoice.tecnospeed_certificado_sandbox', repr(self.tecnospeed_certificado_sandbox))  # noqa
        set_param('br_account_einvoice.tecnospeed_certificado_producao', repr(self.tecnospeed_certificado_producao))  # noqa
