...
class AccountConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        tecnospeed_certificado_id_producao = get_param(
            'br_account_einvoice.tecnospeed_certificado_id_producao',
        )

        res.update({
            'tecnospeed_certificado_id_sandbox': tecnospeed_certificado_id_sandbox,
            'tecnospeed_certificado_id_producao': tecnospeed_certificado_id_producao,
        })
    ...
    def set_values(self):
        ...
        set_param(
            'br_account_einvoice.tecnospeed_certificado_id_producao',
            repr(self.tecnospeed_certificado_id_producao),
        )
