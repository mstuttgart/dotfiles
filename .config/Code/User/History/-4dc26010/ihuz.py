...
class TestBrZipAbstract(TransactionCase):
    ...
    def test_get_address_from_zip_excecao_pycepcorreios(self, mk):
        ...
        self.assertEqual(address['search_cep_exception'], 'Tempo de consulta expirado:. Contate o administrado do sistema')
        ...
        self.assertEqual(address['search_cep_exception'], 'Erro na requisição HTTP:. Contate o administrado do sistema')
        ...
        self.assertEqual(address['search_cep_exception'], 'Ocorreu um erro desconhecido. Contate o administrado do sistema. Erro:')
