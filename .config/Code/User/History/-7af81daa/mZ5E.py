...
class AccountInvoice(models.Model):
    ...
    def _compute_anticipated_value(self):
        ...
        for invoice in invoices:
            anticipated_value = -1
            anticipated_residual_value = -1
            anticipated_residual_payment = -1
    ...
    def action_br_account_invoice_open(self):
        ...
        if self._hook_validation():
            # Ajustamos os valores dod impostos (detalhes no doc. do metodo)
    ...
    def action_br_account_invoice_recompute_tax(self):
        ...
        for inv in self:
            ...
            if inv.position_type == 'service' and inv.state == 'draft':

                # Calculos realizados a partir da tax_line devido a sitacoes de
                # calculo de valor minimo e tambem para evitar reacalcular o
