...
source bin/prod-1-update-all.sh > crontab-hotfix.log 2>&1 &
source bin/prod-2-update-all.sh > crontab-hotfix.log 2>&1 &
source bin/prod-3-update-all.sh > crontab-hotfix.log 2>&1 &
source bin/prod-4-update-all.sh > crontab-hotfix.log 2>&1 &
source bin/prod-5-update-all.sh > crontab-hotfix.log 2>&1
