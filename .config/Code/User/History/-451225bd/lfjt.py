...
class InvoiceElectronic(models.Model):
    ...
    tecnospeed_danfe = fields.Binary(string='DANFE')
    tecnospeed_danfe_name = fields.Char(string='DANFE Filename')

    tecnospeed_xml = fields.Binary(string='XML')
    tecnospeed_xml_name = fields.Char(string='XML Filename')
