    ...
    def get_mail_template_items(self):
        ...
        for nfse in nfse_done:
            ...
            if mail_template:
                ...
                raise UserError(f'Modelo de email para NFSe da empresa {nfse.company_id.name} não configurado!')
        ...
        for nfse in nfse_cancel:
            ...
            if mail_template:
                ...
                raise UserError(f'Modelo de email de cancelamento para NFSe da empresa {nfse.company_id.name} não configurado!')
