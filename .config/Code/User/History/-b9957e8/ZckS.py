    ...
    def get_mail_template_items(self):
        ...
        for nfse in nfse_done:
            ...
            if mail_template:
                ...
                raise UserError(
                    'Modelo de email para NFSe da empresa %s não configurado!' % nfse.company_id.name)
        ...
        for nfse in nfse_cancel:
            ...
            if mail_template:
                ...
                raise UserError(
                    'Modelo de email de cancelamento para NFSe da empresa %s não configurado!' % nfse.company_id.name)
